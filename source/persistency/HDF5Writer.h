...
namespace nexus {
  ...
  public:
    ...
    /// open file
    void Open(std::string filename, bool debug, bool save_str, bool save_cluster_counts);
    ...
    void WriteHitInfo(bool str, int64_t evt_number, int particle_indx, int hit_indx, float hit_position_x, float hit_position_y, float hit_position_z, float hit_time, float hit_energy, const char* label_str, int label, int cluster_id);
    ...
    void WriteClusterCount(int64_t evt_number, int cluster_count);
  ...
  private:
    ...
    size_t iclustercount_; ///< counter for cluster counts
