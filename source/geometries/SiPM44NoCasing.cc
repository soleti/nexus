...
namespace nexus {
  ...
  SiPM44NoCasing::SiPM44NoCasing(): GeometryBase(),
		    visibility_(1)

  {
    /// Messenger
    msg_ = new G4GenericMessenger(this, "/Geometry/NextNew/", "Control commands of geometry NextNew.");
    msg_->DeclareProperty("SiPM44NoCasing_vis", visibility_, "SiPM44NoCasing Visibility");
  }



  SiPM44NoCasing::~SiPM44NoCasing()
  {
  }



  G4ThreeVector SiPM44NoCasing::GetDimensions() const
  {
    return dimensions_;
  }
  ...
  void SiPM44NoCasing::Construct()
  {
    // PACKAGE ///////////////////////////////////////////////////////

    G4double sipm_x = 4 * mm;
    G4double sipm_y = 4 * mm;
    ...
    G4Box* sipm_solid = new G4Box("SiPM44NoCasing", sipm_x/2., sipm_y/2., sipm_z/2);

    G4Material* silicone = materials::OpticalSilicone();
    silicone->SetMaterialPropertiesTable(opticalprops::OptCoupler());

    G4LogicalVolume* sipm_logic =
      new G4LogicalVolume(sipm_solid, silicone, "SiPM44NoCasing");
    ...
    G4String sdname = "/SiPM44NoCasing/SiPM";
