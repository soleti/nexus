...
namespace nexus {
  ...
  void CsI::Construct()
  {
    ...
    //   new G4OpticalSurface("PTFE_OPSURF", LUT, polishedteflonair, dielectric_LUT);
    //   opsur_ptfe->SetMaterialPropertiesTable(opticalprops::PTFE());
    // new G4LogicalSkinSurface("PTFE_OPSURF", teflon_logic, opsur_ptfe);
    // new G4LogicalSkinSurface("PTFE_OPSURF", teflon_back_logic, opsur_ptfe);
